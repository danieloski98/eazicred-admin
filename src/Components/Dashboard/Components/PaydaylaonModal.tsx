...
export default function PaydaylaonModal({ loan, open, close }: IProps) {
    ...
    // trigger download
    const download = async (linkk: any, name?: string) => {
    ...
    return (
        <DialogRoot onOpenChange={() => close()} open={open} size="lg" placement={'center'} scrollBehavior="inside">
            <DialogContent>
                <DialogBody>
                    ...
                    <div className="flex w-full justify-between h-auto mt-4 mb-6  border-b-2">

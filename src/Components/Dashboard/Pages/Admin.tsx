...
const getAgents = async (token: string) => {
    console.log(token);
    const res = await fetch(`${local}/admin/admins`, {
        method: 'get',
        headers: {
...
export default function Admin() {
    ...
    const [currentAdmin, setCurrentAdmin] = React.useState({} as IAdmin);
    ...
    const selectagent = (admin: IAdmin) => {
       ...
       <div className="w-full h-full flex flex-col">
            ...
            <div className="w-full h-24 flex justify-between items-center">
                ...
                <div className="flex flex-col">
                    <h2 className="text-xl font-bold text-gray-600">Admins</h2>
                    <p className="text-md text-gray-500 mt-2 font-sans">List of admins on EaziCred</p>
                </div>
            ...
            </div>
            {
                loading && (
                        ...
                        <div className="w-full flex flex-col items-center mt-10">
                            ...
                            <p className="text-eazicred text-xl mt-6">Getting Admin</p>
                        </div>
                    )
            }
            {
               ...
               !loading && !error && (
                ...
                <table className="h-auto overflow-y-auto w-full">
                        ...
                        <tr className="h-10  border-b-2 border-gray-200">
                            ...
                            <th className="w-40 text-left">Role</th>
                        ...
                        </tr>
                        {
                            users.filter((val) => {
                                ...
                                <tr className="pt-6" key={index.toString()}>
                                    ...
                                    <td className="pt-6 text-sm">{items.role === 1 ? 'Super Admin':'Admin'}</td>
                                    <td className="pt-6 text-sm">
                                        <button onClick={() => selectagent(items)} className="w-24 text-eazicred bg-blue-100 text-sm h-8 rounded">View Admin</button>
                                    </td>
                                </tr>
                            ))
                        }
